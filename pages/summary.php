...
<div id="big_basket">
	...
	<form action="" method="post" id="frm_basket">
		...
		<div class="fl_r paypal"
			id="<?php echo $token1; ?>">
			<span class="btn btn-info">Proceed to PayPal</span>
		</div>
		...
		<div class="fl_l">
			<a href="<?php echo $this->objUrl->href('basket'); ?>" class="btn btn-info">Amend order</a>
		</div>
...
<div class="dn">
	<img src="<?php echo SITE_URL; ?>/images/loadinfo.net.gif" alt="Proceeding to PayPal" />
</div>
